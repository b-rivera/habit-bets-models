...
exports.PeriodicHabit = void 0;
var Habit_1 = require("./Habit");
var PeriodicHabit = /** @class */ (function (_super) {
    __extends(PeriodicHabit, _super);
    function PeriodicHabit(id, name, description, category, dateCreated, type, period, status, penalty, numRequired, checkins, archivedDate) {
    ...
    return PeriodicHabit;
}(Habit_1.Habit));
exports.PeriodicHabit = PeriodicHabit;
